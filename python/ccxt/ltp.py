...
class ltp(Exchange, ImplicitAPI):
    ...
    def fetch_markets(self, params={}) -> List:
    ...
    def fetch_funding_balance(self, params={}) -> Balances:
        response = self.privateGetApiV1AssetGetaccountcurrencyinfo(params)
    ...
    def fetch_trading_balance(self, params={}) -> Balances:
        response = self.privateGetApiV1TradingAccount(params)
    ...
    def fetch_currencies(self, params={}) -> Currencies:
        response = self.privateGetApiV1AssetCurrencies(params)
        data = self.safe_list(response, 'data', [])
        result: dict = {}
        for entry in data:
    ...
    def fetch_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List:
        response = self.privateGetApiV1DepositList(params)
        data = self.safe_list(response, 'data', [])
        return data

    def fetch_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List:
        response = self.privateGetApiV1UserwithdrawrecordList(params)
        data = self.safe_list(response, 'data', [])
        return data

    def fetch_transfers(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List:
        response = self.privateGetApiV1TransferList(params)
        data = self.safe_list(response, 'data', [])
        return data
